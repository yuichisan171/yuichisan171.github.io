...
|JavaScript(1年以上)||
|Ruby(1年以上)||
|SQL(1年以上)|外部結合を理解している。|

Frameworks  
|技術|スキルレベル|
|:-|:-|
|Ruby on Rails(1年以上)|簡単なアプリが作れる|
|Node.js(6ヶ月以上))|簡単なアプリが作れる|
|Vue.js (1年以上)●|同上|
|Nuxt.js (1ヶ月)●|起動、構築が可能。|

Tools  
|技術|スキルレベル|
|:-|:-|
|Git (1年以上)|commit,merge,pullなどの基本的なコマンドが操作できる。HEADの意味を理解している。|
|MySQL (1年以上)|簡単なアプリが作れる|
|PostgreSQL (1年以上)|同上|
|AWS (1年以上) ●|S3のバケットは作れるが、画像の疎通連携は協力が必要。|
|Heroku (6ヶ月以上)|アプリのデプロイはできる|
|VSCode (1年以上) ●|ファイル・フォルダの新規作成、コーディングなど基本的な操作はできる。拡張機能の導入は可能。|
|Excel (5年以上) ●|Sum,Avgなどの簡単な関数はできる。VLOOKUOP関数,IF関数は使用経験なし。|
|Word (5年以上) ●|簡単な資料は作れる。(マニュアル、議事録)|
|PowerPoint (5年以上) ●|スライドの作成、文字・画像挿入。メンバーと共同でプレゼン製作ができる。|
